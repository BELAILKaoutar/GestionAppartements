...
if (isset($_POST['submit'])) {
  ...
  if ($password == $cpassword) {
      ...
      if (!$result->num_rows > 0) {
          $sql = "INSERT INTO utilisateur (username,cin,tél,sexe,date_naissance, email, password)
                        ...
                        <div class="col-md-12 col-xs-12 register-blocks">
                            ...
                            <form method="post">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="cin" value="<?php echo $cin; ?>" required>
                                </div>
                                <div class="form-group">
                                    <label for="name">Tél</label>
                                    <input type="text" class="form-control" id="tél" value="<?php echo $tél; ?>" required>
                                </div>  
                                <div class="form-group">
                                    <label for="name">Sexe</label>
                                    <input type="text" class="form-control" id="sexe" value="<?php echo $sexe; ?>" required>
                                </div> 
                                <div class="form-group">
                                    <label for="name">Birthday Date</label>
                                    <input type="text" class="form-control" id="date_naissance" value="<?php echo $date_naissance; ?>" required>
                                </div>                                                              
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="email" value="<?php echo $email; ?>" required>
                                </div>
                                <div class="form-group">
                                    <label for="password">Password</label>
                                    <input type="password" class="form-control" id="password" value="<?php echo $_POST['password']; ?>" required>
                                </div>
                                <div class="form-group">
                                    <label for="password">Confirm password</label>
                                    <input type="password" class="form-control" id="cpassword" value="<?php echo $_POST['cpassword']; ?>" required>
                                </div>
