...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse yamm" id="navigation">
                    ...
                    <ul class="main-nav nav navbar-nav navbar-right">
                        ...
                        <li class="wow fadeInDown active" data-wow-delay="0.3s"><a class="" href="locataires.php">Locataires</a></li>
    ...
    <?php 
       ...
       $req=mysqli_query($conn,"SELECT * FROM personne where role='L' ");
       if(mysqli_num_rows($req)==0){
          //s'il n'existe pas d'employé dans la base de données,alors on affiche ce message:
          echo"there are no persons yet add!";
       }else{
